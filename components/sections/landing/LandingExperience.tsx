...
export function LandingExperience({
  ...
  return (
    <div className="relative overflow-x-clip" data-cursor-tone="dark">
      <section
        ref={heroSectionRef}
        className="relative isolate flex min-h-[calc(100svh-4.5rem)] items-center overflow-hidden py-3 sm:min-h-[calc(100svh-5rem)] sm:py-6"
      ...
      >
        ...
        <div className="container py-3 sm:py-6">
          <div className="mx-auto w-full rounded-[2rem] border border-brand/20 bg-white/78 px-4 py-6 shadow-[0_0_0_1px_hsl(var(--border))_inset,0_30px_90px_-45px_hsl(var(--brand)/0.28)] backdrop-blur-xl dark:border-border/70 dark:bg-black/45 dark:shadow-[0_0_0_1px_hsl(var(--border))_inset,0_30px_90px_-45px_hsl(var(--brand)/0.45)] sm:px-8 sm:py-10 lg:px-10 lg:py-12">
            <div className="hero-meta mb-4 inline-flex items-center gap-2 rounded-full border border-emerald-500/35 bg-emerald-500/12 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-[0.08em] text-emerald-700 dark:border-emerald-400/30 dark:bg-emerald-500/10 dark:text-emerald-300 sm:mb-6 sm:px-4 sm:py-2 sm:text-xs sm:tracking-[0.1em]">
            ...
            <div className="space-y-1.5 sm:space-y-2">
              <h1
                ref={swikritRef}
                className="break-words font-heading text-3xl font-bold uppercase leading-[1.02] tracking-[0.06em] sm:text-6xl sm:tracking-[0.12em] lg:text-7xl"
              >
                {firstName}
              </h1>
              <h1
                ref={pokhrelRef}
                className="break-words font-heading text-3xl font-bold uppercase leading-[1.02] tracking-[0.06em] text-brand sm:text-6xl sm:tracking-[0.12em] lg:text-7xl"
              >
                {lastName}
              </h1>
            </div>

            <p className="hero-meta mt-4 text-sm font-semibold tracking-[0.1em] text-muted-foreground sm:mt-6 sm:text-lg sm:tracking-[0.16em] lg:text-xl">
            ...
            <div className="hero-meta mt-5 flex flex-wrap items-center gap-3 text-xs text-muted-foreground sm:mt-8 sm:text-sm">
            ...
            <div className="hero-meta mt-5 grid gap-2.5 sm:mt-7 sm:grid-cols-3 sm:gap-3">
              {heroStats.map((stat, index) => (
                <div
                  key={stat.label}
                  className="rounded-2xl border border-border/70 bg-background/55 p-4"
                >
                  <p className="font-heading text-2xl font-bold text-brand sm:text-4xl">
                    <span
                      ref={(node) => {
            ...
            <div className="hero-meta mt-5 flex flex-wrap gap-3 sm:mt-7">
      ...
      <section className="border-y border-border/70 bg-black py-4 sm:py-5" data-cursor-tone="dark">
        <div className="overflow-hidden py-1">
          <div ref={marqueeRowOneRef} className="flex min-w-max gap-4 whitespace-nowrap text-xs font-semibold uppercase tracking-[0.1em] text-white/90 sm:gap-6 sm:text-sm sm:tracking-[0.18em]">
        ...
        <div className="mt-2 overflow-hidden py-1">
          <div ref={marqueeRowTwoRef} className="flex min-w-max gap-4 whitespace-nowrap text-xs font-semibold uppercase tracking-[0.1em] text-white/55 sm:gap-6 sm:text-sm sm:tracking-[0.18em]">
            {Array.from({ length: 4 }).map((_, index) => (
      ...
      <section className="container py-12 sm:py-16 lg:py-20" data-cursor-tone="dark">
        <div
          className={cn(
        ...
        >
          <div>
            <Badge variant="brand" className="mb-3 w-fit sm:mb-4">
              Video Editor · Motion Designer
            </Badge>
            <h2
              ref={aboutHeadingRef}
              className="font-heading text-2xl font-bold leading-tight sm:text-4xl lg:text-5xl"
            >
              Hey, I&apos;m {profile.display_name}
            </h2>
            <p className="mt-3 max-w-2xl text-[15px] leading-relaxed text-muted-foreground sm:mt-6 sm:text-lg">
              {profile.bio}
            </p>
          </div>
      ...
      <section className="container pb-12 sm:pb-16 lg:pb-20" data-cursor-tone="dark">
        <div className="mb-5 flex items-end justify-between gap-4 sm:mb-7">
          <h3 className="font-heading text-2xl font-bold sm:text-4xl">Skills & Tools</h3>
      ...
      <section id="featured-work" className="container pb-12 sm:pb-16 lg:pb-20" data-cursor-tone="dark">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-4 sm:mb-8">
          <div>
            ...
            <h3 className="mt-2 max-w-[18ch] font-heading text-2xl font-bold sm:max-w-none sm:text-3xl lg:text-4xl">
        ...
        <div ref={featuredGridRef} className="grid gap-4 sm:gap-5 md:grid-cols-2 xl:grid-cols-3">
              ...
              >
                {thumbnailUrl ? (
                  <div className="relative h-48 overflow-hidden sm:h-56 lg:h-64">
                    ...
                    <div className="absolute bottom-4 left-4 right-4 flex items-center justify-between opacity-100 transition-opacity duration-300 md:opacity-0 md:group-hover:opacity-100">
                      <MagneticButton
                        href={projectUrl}
                        variant="brand"
                        size="sm"
                ...
                <CardContent className="space-y-3 p-4 sm:p-5">
                  ...
                  <h4 className="font-heading text-lg font-semibold leading-tight sm:text-xl">{item.title}</h4>
      ...
      <section className="container pb-12 sm:pb-16 lg:pb-20" data-cursor-tone="dark">
        <div className="mb-5 flex flex-wrap items-end justify-between gap-4 sm:mb-8">
          <h3 className="font-heading text-2xl font-bold sm:text-4xl">Services Teaser</h3>
          ...
          <div className="grid gap-4 sm:gap-5 md:grid-cols-2 xl:grid-cols-4">
            {serviceTeasers.map((service) => (
              <div key={service.id} className="group [perspective:1200px]">
                <div className="relative h-60 w-full rounded-2xl transition-transform duration-700 [transform-style:preserve-3d] md:h-72 md:group-hover:[transform:rotateY(180deg)]">
                  <div
                    className={cn(
                      "absolute inset-0 flex flex-col items-center justify-center rounded-2xl p-5 text-center [backface-visibility:hidden] sm:p-6",
                      service.theme.front
                    )}
                  >
                    ...
                    <h4 className="mt-3 font-heading text-xl font-semibold sm:mt-4 sm:text-2xl">{service.title}</h4>
                    <p className="mt-3 text-sm text-muted-foreground md:hidden">{service.description}</p>
                    <p className="mt-4 font-heading text-lg font-semibold text-brand md:hidden">{service.price}</p>
                  </div>

                  <div
                    className={cn(
                      "absolute inset-0 hidden flex-col justify-center rounded-2xl p-5 [backface-visibility:hidden] [transform:rotateY(180deg)] md:flex",
                      service.theme.back
                    )}
                  >
      ...
      <section ref={testimonialSectionRef} className="overflow-hidden pb-12 sm:pb-16 lg:pb-20" data-cursor-tone="dark">
        <div className="container mb-5 sm:mb-8">
          <h3 className="font-heading text-2xl font-bold sm:text-4xl">Testimonials</h3>
        </div>

        {testimonialItems.length > 0 ? (
          <div className="relative overflow-hidden">
            <div ref={testimonialTrackRef} className="flex w-max gap-4 px-4 sm:gap-5 md:px-8">
              {[...testimonialItems, ...testimonialItems].map((item, index) => (
                <Card
                  key={`${item.id}-${index}`}
                  className="w-[280px] shrink-0 border-border/70 bg-card/80 sm:w-[320px]"
                >
      ...
      <section className="relative isolate overflow-hidden bg-black py-14 sm:py-16 lg:py-20" data-cursor-tone="dark">
        ...
        <div className="container text-center">
          <h3
            ...
            className="mx-auto max-w-4xl bg-[linear-gradient(90deg,#ffffff_0%,#8b5cf6_35%,#ffffff_70%,#8b5cf6_100%)] bg-[length:200%_100%] bg-clip-text font-heading text-3xl font-bold text-transparent sm:text-5xl lg:text-6xl"
          >
